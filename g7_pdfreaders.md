...
1. **Violin Plot of Energy Consumption per Run:** This plot compares the energy consumption distribution for Chrome and Safari. ![](images/violin_plot_with_outliers.png)
2.**Time Series Plot of Power Consumption:** Displays power usage patterns over time for both PDF readers. ![](images/time_series.png)
